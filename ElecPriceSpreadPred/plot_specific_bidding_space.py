...
if __name__ == '__main__':
    ...
    da_snippets = [result[d]['日前竞价空间'] for d in sorted(result)]

    # indices_to_plot = [532, 524, 442]
    indices_to_plot = [726,	714]
    indices_to_plot = [714, 706, 712]
    ...
    for idx in indices_to_plot:
        ...
        time_points = np.arange(len(curve))  # 0~95 点
    ...
    # 图表样式
    plt.title("日前竞价空间 - 每日96点曲线对比", fontsize=14)
    plt.xlabel("时段点 (0~95)", fontsize=12)
